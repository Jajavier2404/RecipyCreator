            ...
            <main className="flex-1 p-4 md:p-8 overflow-auto relative">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <header className="mb-8 text-center">
                        <h1 className="text-4xl md:text-5xl font-bold text-[#295F4E] mb-2">
                            Tu Receta Perfecta
                        </h1>
                        <p className="text-[#A63D40] text-lg max-w-2xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="bg-white rounded-lg shadow-md p-6 border border-[#295F4E]/20">
                                <h2 className="text-3xl font-bold text-center text-[#295F4E] mb-2 uppercase">
                                    {recipe.title}
                                </h2>
                            </div>
                            ...
                            <div className="bg-white rounded-lg shadow-md p-6 border border-[#295F4E]/20">
                                <h3 className="text-xl font-semibold text-[#295F4E] mb-3">Descripción</h3>
                                <p className="text-gray-700">{recipe.description}</p>
                                
                                {/* Etiquetas de información */}
                                <div className="flex flex-wrap gap-3 mt-4">
                                    <span className="bg-[#F18F01]/10 text-[#F18F01] px-3 py-1 rounded-full text-sm font-medium">
                                        ⏱️ {recipe.time}
                                    </span>
                                    <span className="bg-[#50B88C]/10 text-[#295F4E] px-3 py-1 rounded-full text-sm font-medium">
                                        🍽️ {recipe.servings}
                                    </span>
                                    <span className="bg-[#A63D40]/10 text-[#A63D40] px-3 py-1 rounded-full text-sm font-medium">
                            ...
                            <div className="bg-white rounded-lg shadow-md p-6 border border-[#295F4E]/20">
                                <h3 className="text-xl font-semibold text-[#295F4E] mb-3">Ingredientes</h3>
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="bg-white rounded-lg shadow-md p-6 h-full border border-[#295F4E]/20">
                                <h3 className="text-xl font-semibold text-[#295F4E] mb-3">Preparación</h3>
